    ...
    >
      ...
      <div className="blueprint-content">
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
        >
          <div className="section-header-row" style={{ padding: '14px 18px' }}>
            <h3 className="section-title">Project UI Preview</h3>
          </div>
        ...
        >
          ...
          <ExecutionFlow
            ...
            onDownload={() => handleDownload(flowchartRef, 'execution-flow')}
          />
        </motion.div>
        ...
        >
          <div className="section-header-row">
            <button className="section-header" onClick={() => toggleSection('references')}>
              <h3 className="section-title">Learning References</h3>
              {expandedSections.references ? <FiChevronUp /> : <FiChevronDown />}
            </button>
          </div>
          {expandedSections.references && (
            ...
            >
              <LearningHub blueprint={blueprint} />
            </motion.div>
          )}
        </motion.div>
